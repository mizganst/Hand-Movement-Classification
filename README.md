...
This project implements a machine learning pipeline to classify hand movements and mobility using motion tracking data. Specifically, it utilizes wearable sensor data (glove-based) from the HANDMI4 dataset to compare different classification algorithms and feature reduction techniques.
...
Frequency-Domain Features: Various frequency-based characteristics extracted prior to dataset splitting.
